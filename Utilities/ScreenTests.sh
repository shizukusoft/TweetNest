...
# xcodebuild -scheme "TweetNest" -testPlan "ScreenTests" -destination 'platform=macOS' -resultBundlePath 'ScreenTests (macOS).xcresult' test
...
# xcodebuild -scheme "TweetNest" -testPlan "ScreenTests" "${ios_destinations[@]}" -resultBundlePath 'ScreenTests (iOS).xcresult' test
...
xcodebuild -scheme "TweetNest Watch App" -testPlan "ScreenTests" "${watchos_destinations[@]}" -resultBundlePath 'ScreenTests (watchOS).xcresult' test
