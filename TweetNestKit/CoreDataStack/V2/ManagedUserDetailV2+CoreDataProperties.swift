//
//  ManagedUserDetailV2+CoreDataProperties.swift
//  TweetNestKit
//
...
extension ManagedUserDetailV2 {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<ManagedUserDetailV2> {
        return NSFetchRequest<ManagedUserDetailV2>(entityName: "UserDetail")
    }
...
extension ManagedUserDetailV2 : Identifiable {
