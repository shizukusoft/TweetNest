...
```
TweetNestはiOSおよびwatchOS、macOSのためのTwitterアカウントマネジャーです。

主な特徴：

プロフィール・フォロー・フォロワーの履歴
あなたのアカウントのプロフィールとフォロー、フォロワーの変化を自動的に確認します。

iCloud Sync
すべての設定とデータをiCloudで同期させます。

プライバシー
すべてのデータはデバイスとiCloudのみに保存されます。

ツイート削除
あなたのツイートをいくつか、もしくはすべて、いっきに削除してみましょう。
```
