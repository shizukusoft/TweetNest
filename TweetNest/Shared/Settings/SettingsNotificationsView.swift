        ...
        Form {
            Section {
                Toggle(
                    ...
                    isOn: Binding<Bool>(
                        get: { managedPreferences.notifyProfileChanges },
                        set: { managedPreferences.notifyProfileChanges = $0 }
                    )
                )
                ...
                Toggle(
                    "Notify Following Changes",
                    isOn: Binding<Bool>(
                        get: { managedPreferences.notifyFollowingChanges },
                        set: { managedPreferences.notifyFollowingChanges = $0 }
                    )
                )
                ...
                Toggle(
                    "Notify Follower Changes",
                    isOn: Binding<Bool>(
                        get: { managedPreferences.notifyFollowerChanges },
                        set: { managedPreferences.notifyFollowerChanges = $0 }
                    )
                )
                ...
                Toggle(
                    "Notify Blocking Changes",
                    isOn: Binding<Bool>(
                        get: { managedPreferences.notifyBlockingChanges },
                        set: { managedPreferences.notifyBlockingChanges = $0 }
                    )
                )
                ...
                Toggle(
                    "Notify Muting Changes",
                    isOn: Binding<Bool>(
                        get: { managedPreferences.notifyMutingChanges },
                        set: { managedPreferences.notifyMutingChanges = $0 }
                    )
                )
